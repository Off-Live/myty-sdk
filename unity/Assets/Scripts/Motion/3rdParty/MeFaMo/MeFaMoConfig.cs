...
namespace Motion._3rdParty.MeFaMo
{
    public static class MeFaMoConfig
    {
        ...
        public static Dictionary<FaceBlendShape, Vector2> remap_config = new()
        {
            ...
            { FaceBlendShape.MouthClose, new Vector2(0.05f, 0.75f) },
            ...
            { FaceBlendShape.MouthFrownLeft, new Vector2(0.4f, 0.9f) },
            { FaceBlendShape.MouthFrownRight, new Vector2(0.4f, 0.9f) },
        ...
        public static readonly double[] canonical_metric_landmarks =
        {
            0.000000,
            -3.406404,
            5.979507,
        ...
        public static readonly Dictionary<int, double> procrustes_landmark_basis = new()
        {
            { 4, 0.070909939706326 },
            { 6, 0.032100144773722 },
